A basic Next.js app that uses [ComputeSDK](https://github.com/computesdk/computesdk) to create a sandbox on Upstash and run the example from the blog post.

See the full walkthrough at [computesdk.com/blog/how-to-run-a-upstash-sandbox](https://www.computesdk.com/blog/how-to-run-a-upstash-sandbox/).
